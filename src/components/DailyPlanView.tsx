...
function weeksUntilDUS(): number {
  ...
  return Math.floor(diff / (1000 * 60 * 60 * 24 * 7)); // negatif değere izin ver
}
        ...
        <div className={`${theme.card} px-3.5 py-2 rounded-xl text-center`}>
          {examPassed ? (
            <>
              ...
              <div className={`${theme.subtext} text-[8px] font-bold uppercase`}>SINAV TAMAM</div>
            </>
          ) : (
            <>
            ...
            return (
              <div key={i} className="flex-1 flex flex-col items-center gap-1 group">
                <div className="relative w-full flex items-end justify-center" style={{ height: '44px' }}>
                  ...
                  {f.count === 0 && (
                    <div
                      className="absolute -top-4 left-1/2 -translate-x-1/2 text-[8px] opacity-20"
